...
class TestIPv4AddressModule(unittest.TestCase):
    ...
    def test_broadcast_address(self):
        ...
        self.assertEqual(
            "192.168.0.256/24", broadcast_address("192.168.0.256/24")
        )
        self.assertEqual(
            "192.168.0.256/24",
            broadcast_address(
        ...
        with self.assertRaises(ValueError):
            broadcast_address("192.168.0.1", raise_error_if_malformed=True)
        # We also want to test two corner cases.
        self.assertEqual("192.168.0.1", broadcast_address("192.168.0.1/32"))
        self.assertEqual("255.255.255.255", broadcast_address("192.168.0.1/0"))
