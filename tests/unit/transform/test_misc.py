...
class TestMiscModule(unittest.TestCase):
    ...
    def test_to_int(self):
        ...
        self.assertEqual(
            5,
            apply_transformation('misc.to_int', '5'))
        ...
        self.assertEqual(
            27,
            to_int('27', raise_error_if_malformed=False))
        self.assertEqual(
            27,
            to_int('27', raise_error_if_malformed=True))
        self.assertEqual(
            'foo',
            to_int('foo'))
        self.assertEqual(
            'foo',
            to_int('foo', raise_error_if_malformed=False))
